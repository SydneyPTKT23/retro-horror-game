...
namespace SLC.RetroHorror.Core
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public bool AnalogMovement { get; set; } = true;
        ...
        private void Update()
        {
            ...
            if (characterController)
            {
                ...
                if (AnalogMovement)
                {
                    ...
                    CalculateAnalogMovementSpeed();
                }
                else
                {
                    HandleTankMovement();
                    HandleTankRotation();
                    CalculateTankMovementSpeed();
                }
        ...
        private void HandleAnalogMovement()
        {
            ...
            relativeForward.eulerAngles = new(0, cameraYRotation, 0);

            desiredDirection = relativeForward * desiredDirection;
            ...
            if (finalVector != Vector3.zero)
                transform.forward = finalVector.normalized;
        }
        ...
        private void CalculateTankMovementSpeed()
        {
        ...
        private void CalculateAnalogMovementSpeed()
        {
            currentSpeed = shiftDown && CanRun() ? runSpeed : walkSpeed;
            currentSpeed *= currentSpeedPenaltyMult;
